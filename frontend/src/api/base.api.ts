...
export const baseApi = createApi({
    ...
    tagTypes: ['Auth', 'Product', 'Store', 'User', 'Order', 'Orders', 'OrderReceipt', 'Sales', 'Requests', 'Users', 'OrderReceipts', 'Stores', 'StoreEmployees', 'ProductAcceptances', 'Vehicles', 'Notifications', 'Announcement', 'Reports', 'Customers', 'CrossConversions', 'BalanceLedger', 'Note', 'Feedbacks'],
    endpoints: () => ({}),
})
